		...
		<div class="create">
			...
			<form id="form1" action="complaint/complaintadd.action" method="post">
				<table class="templatemo-container">
					<!-- <tr>
						<td>申请服务类型kindid：<select id="kindid" name="kindid">
					...
					<tr>
						<td>服务名称title:<input id="title" type="text"
							class="form-control" name="title" />
						</td>
					</tr>

					<tr>
						<td>服务信息info:<br /> <textarea class="form-control" id="info"
								name="info" style="width: 1024px; resize: none;"></textarea>
						</td>
					</tr>
					<tr>
